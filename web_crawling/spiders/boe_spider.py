...
class BoeSpider(Spider):
    ...
    def save_xml_disposition(self, response):
        ...
        tags = {
            # TODO Revisar. No tiene texto, pero sí etiqueta fecha_actualizacion
            "boe_disposicion_id": response.xpath(
                "//identificador/text()"
            ).get(),
            ...
            "vigencia_agotada": response.xpath(
        ...
        disposition = BoeDisposition.parse_obj(tags)
        yield disposition
